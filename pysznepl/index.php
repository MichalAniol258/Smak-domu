...
<div class="user-profile">
   ...
   <div class="flex">
   <a href="niewiem.php" class="btn"><img src="images/shopping.svg" alt="" srcset=""></a>
      ...
      <a href="main.html" id="amogus" class="delete-btn">back →</a>
   </div>
...
<div class="products">
   ...
   ?>
      <form method="post" class="box" action="">
         ...
         <div class="price">zł<?php echo $fetch_product['price']; ?>/-</div>
